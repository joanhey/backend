...
TableTools.BUTTONS = {
	...
	"copy": $.extend( {}, TableTools.buttonBase, {
		...
		"fnComplete": function(nButton, oConfig, flash, text) {
			...
			this.fnInfo( '<h6>Tabla copiada</h6>'+
				'<p>'+len+' fila'+plural+' copiada'+plural+'.</p>',
				1500
			);
		}
	} ),
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h6>Vista de impresion</h6><p>Ppr favor utiliza la opcion imprimir de tu explorador "+
		  " para imprimir esta tabla. Presiona escape para finalizar.",
		"sMessage": null,
		"bShowAll": true,
		"sToolTip": "Ver vista preliminar",
